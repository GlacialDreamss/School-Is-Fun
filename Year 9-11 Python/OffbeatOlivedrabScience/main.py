...
while dayCondition=="herro":
  ...
  if day=="Monday":
    print("Valid")
    dayFile=open("Monday.txt","w")
    dayNum=1
  elif day=="Tuesday":
    print("Valid")
    dayFile=open("Tuesday.txt","w")
    dayNum=2
  elif day=="Wednesday":
    print("Valid")
    dayFile=open("Wednesday.txt","w")
    dayNum=3
  elif day=="Thursday":
    print("Valid")
    dayFile=open("Thursday.txt","w")
    dayNum=4
  elif day=="Friday":
    print("Valid")
    dayFile=open("Friday.txt","w")
    dayNum=5
  else:
      ...
      while check!="Y":
        ...
        if check=="Y":
          ...
          if dayNum==1:
            ...
            dayFile=open("Wednesdayday.txt","w") 
          elif dayNum==4:
            dayFile=open("Thursday.txt","w") 
          else:
            dayFile=open("Friday.txt","w")         
